...
<script>(function(d, s, id) {
  ...
  js.src = 'https://connect.facebook.net/pt_BR/sdk.js#xfbml=1&version=v3.0&appId=255350451478139&autoLogAppEvents=1';
        ...
        if (allimages[i].getAttribute('data-src')) {
            allimages[i].setAttribute('src', allimages[i].getAttribute('data-src'));
				...
				if (document.documentElement.clientWidth < 550) {
					if (allimages[i].getAttribute('mobile-src')) {
	            allimages[i].setAttribute('src', allimages[i].getAttribute('mobile-src'));
	        }
				}else{
					if (allimages[i].getAttribute('full-src')) {
	            allimages[i].setAttribute('src', allimages[i].getAttribute('full-src'));
	        }
				}
    }
}, false)
